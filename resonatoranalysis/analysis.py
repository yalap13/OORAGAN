...
def fit_resonateur_test(
    ...
    """
    Is a copy of fit_resonateur but with check_fit and this awesome fit testing shrunked data until it works!
    ...
    savepic : bool, optional
        If True, saves the fit plots generated by the function in the Images folder in the same directory.
        The default is False.
    savepath : str, optional
        Where to save the graph, savepic must be True. The default is "".
    write : bool, optional
        Choose whether to write the fit results in a .txt file in the Fit results folder in the same directory or not.
        The default is False.
    threshold : float, optional
        A value greater than 0 which determine the error tolerance on fit values. The default is 1 (100%).
    start : int, optional
    ...
    coupling_loss = couploss
    internal_loss = intloss
    dictoflist = {}
    dictio, r = {}, {}
    data_store = {
        "Q_c": [],
    ...
    params = lmfit.Parameters()
    params.add(name="internal_loss", value=internal_loss)
    params.add(name="coupling_loss", value=coupling_loss)
    params.add(name="resonance_frequency", value=resonance_frequency, min=1e9, max=1e10)
